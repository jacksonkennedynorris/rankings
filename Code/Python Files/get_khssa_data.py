...
##Folder
folder = sports_abb[index] + '/' + str(year)
...
if index == 0:
   ...
   directory = os.path.dirname('../MATLAB/Football/Data/' + str(year) + "/HTML")
   year = str(year)
   ...
   for subdir, dirs, files in os.walk(directory):
       for file in files:
           ...
           # Write to file
           f = open('../MATLAB/Football/Data/' + year + '/game_infos/%s' % filename, 'w')
...
teams = sorted(teams)
directory = os.path.dirname('../MATLAB/Football/Data/' + str(year) + "/game_infos")
...
for subdir, dirs, files in os.walk(directory):
    for file in files:
        ...
        # Write to file
        f = open('../MATLAB/Football/Data/' + year + '/game_summaries/game_summary_%s.txt' % filename, 'w')
