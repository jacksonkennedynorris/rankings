function [average_rating, Teams]=get_aggregate_ratings(Teams, year)
...
masseyFile = strcat("Data/" + num2str(year) + "/Ratings/masseyRating.txt");
colleyFile = strcat("Data/" + num2str(year) + "/Ratings/colleyRating.txt");
eloFile = strcat("Data/" + num2str(year) + "/Ratings/eloRating.txt");
...
elo_file = "Data/" + num2str(year) + "/Ratings/normalizedEloRating.txt"; 
mass_file = "Data/" + num2str(year) + "/Ratings/normalizedMasseyRating.txt";
coll_file = "Data/" + num2str(year) + "/Ratings/normalizedColleyRating.txt";
save(elo_file,'eloNormal','-ascii')
save(coll_file,'colleyNormal','-ascii')
save(mass_file,'masseyNormal','-ascii')
save("Data/" + num2str(year) + "/Ratings/averageRating.txt",'average_rating','-ascii')
